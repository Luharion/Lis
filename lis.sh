...
dotfilesrepo="https://github.com/Luharion/artixrice.git"
progsfile="https://raw.githubusercontent.com/Luharion/Lis/master/progs.csv"
aurhelper="yay"
repobranch="master"
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to L0kcy install script!\\n\\nThis script will automatically install GNU/Linux with DWM and my dotfiles.\\n\\n-Luke" 10 60
...
preinstallmsg() {
	whiptail --title "Let's get this party started!" --yes-button "Ready!" \
		--no-button "No, thank you!" \
		--yesno "The rest of the installation will now be totally automated, so you can sit back and\\n\\nNow just press <Ready!> and the system will begin installation!" 13 60 || {
		clear
		exit 1
	}
}
...
maininstall(){
		whiptail --title "L0cky install" --infobox "Installing \`$1\` ($n of $total). $1 $2" 9 70 
		installpkg "$1"
...
vimplugininstall() {
 ...
 ~/.local/share/nvim/site/pack/packer/start/packer.nvim
	sudo -u "$name" nvim -c "PackerSync|q|q"
}
